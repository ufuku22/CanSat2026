...
class RedConeConfig:
    ...
    ROTATE_SPEED = 40.0                               #探索・位置合わせ旋回時のモーター出力[%]
...
class RedBallConfig:
    ...
    INITIAL_SIDE_TARGET_DISTANCE_M = 0.40              #初回ボールが左右端の場合の停止目標距離[m]
...
class MissionConfig:
    ...
    RELEASE_BELOW_THRESHOLD_OFFSETS_HPA = (0, 0) #(0.6, 1.2)
    RELEASE_ABOVE_THRESHOLD_OFFSETS_HPA = (0, 0) #(0.8, 0.3)
