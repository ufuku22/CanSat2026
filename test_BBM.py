...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--image-width", type=int, default=480, help="maximum compressed image width")
    parser.add_argument("--image-height", type=int, default=360, help="maximum compressed image height")
    parser.add_argument("--jpeg-quality", type=int, default=60, help="initial JPEG quality from 1 to 100")
    parser.add_argument("--target-image-bytes", type=int, default=10000, help="target compressed image size")
    parser.add_argument("--max-image-bytes", type=int, default=12000, help="maximum accepted compressed image size")
    parser.add_argument("--min-image-width", type=int, default=320, help="minimum compressed image width")
    parser.add_argument("--min-image-height", type=int, default=240, help="minimum compressed image height")
